...
cp Dokumente\ AG/Ausschreibung/ausschreibung.pdf final/Ausschreibung
...
cp Dokumentenordner/Firmenporträt/firmenportraet.pdf final/Firmenportraet_AN.pdf
...
cp Projektordner\ UML/*.pdf final
