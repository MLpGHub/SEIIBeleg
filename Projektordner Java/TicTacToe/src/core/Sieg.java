...
public class Sieg extends InfoScreen {
  ...
  public Sieg(Driver driver) {
    super(driver, driver.getToolkit().getImage("resources/hintergrund.jpg"));
    sieger = 0;

    unentschieden = this.getToolkit().getImage("resources/ergebnis_unentschieden.jpg");
    spieler1 = this.getToolkit().getImage("resources/ergebnis_O_gewinnt.jpg");
    spieler2 = this.getToolkit().getImage("resources/ergebnis_X_gewinnt.jpg");
  ...
  /**
   * Gibt eine Repräsentation des Siegers zurück.
   * @return sieger
   */
