...
\item Aktualisierung UML (alle, 1h)
\item Update Pflichtenheft (Herr Leopold, 1h)
\end{itemize}
...
\uline{Fertiggestellt:}
\begin{itemize}\itemsep0em
\item Präsentation überarbeitet (alle, 1.5h)
\item Aktualisierung JUnit-Test (Herr Günther, 1h)
\end{itemize}
...
\newpage
\subsection{Letzter Treff vor Abgabe - About Button}
Datum: 19.06.2019 \\
-
\uline{Fertiggestellt:}
\begin{itemize}\itemsep0em
\item Präsentation (alle, 1.5h)
\item Merge und Update Master (Herr Günther, 2h)
\end{itemize}
