...
\textbf{Pflichten\-heft}	&Soll&&&Fehlerkorrektur nach Korrektur von Praktikumsleiter&&&&&&\\ \hline &Ist&&&Ist korrgiert&&&&&&\\ \hline
\textbf{Umgebung}		&Soll&&&&&&&&&\\ \hline &Ist&&&&&&&&&\\ \hline
\textbf{Diagramme}		&Soll&Korrekte UML&&Unnötige Elemente entfernen&&&&&&\\ \hline &Ist&&&&&&&&&\\ \hline
